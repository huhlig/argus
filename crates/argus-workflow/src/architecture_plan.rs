...
const MAX_SCOPE_CONSTITUENTS: usize = 512;
const MAX_SCOPE_INTERNAL_RELATIONS: usize = 1_024;
const MAX_SCOPE_BOUNDARY_RELATIONS: usize = 512;
const MAX_SCOPE_EVIDENCE_BYTES: usize = 128 * 1_024;
